...
import { VoicePresetConfirmModal } from './components/VoicePresetConfirmModal';
import { AutoRangeConfirmModal } from './components/AutoRangeConfirmModal';
...
export default function App() {
  ...
  return (
    <div id="karaoke-root" className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-emerald-500 selection:text-slate-900">
      ...
      <AnimatePresence>
        {presetToConfirm && (
          <VoicePresetConfirmModal
            presetToConfirm={presetToConfirm}
      ...
      <AnimatePresence>
        {confirmSwitchAutoRange && autoRangeDiff && (
          <AutoRangeConfirmModal
            autoRangeDiff={autoRangeDiff}
            onConfirm={() => {
      ...
      <AnimatePresence>
        {isAdminOpen && (
          <AdminPortalModal
            ...
            onCleanupDuplicates={cleanupDuplicateSongs}
            ...
            onDeleteSong={handleDeleteAdminSong}
            onSaveForm={handleSaveAdminForm}
